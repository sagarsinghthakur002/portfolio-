        ...
        <div className="flex flex-row xl:px-[7rem] px-4">
          ...
          <div className="flex-1">
            <Tabs defaultValue="personal">
              <TabsList className="w-full grid grid-cols-3 xl:max-w-[520px] xl:border dark:border-0">
              ...
              <div className="text-lg mt-12 xl:mt-8">
                ...
                <TabsContent value="personal">
                  <div className="text-center xl:text-left">
                    <h3 className="h3 mb-4">Building scalable and user-friendly web apps for 1 year.</h3>
                    <p className="subtitle max-w-xl mx-auto xl:mx-0">
                      Blending creativity with clean code, I design and build web
                      applications that are not only scalable but also intuitive and visually engaging.
                    </p>
                      ...
                      {getData(qualificationData, "Education").data.map((item, index) => {
                        ...
                        return (
                          <div key={index} className="flex flex-col gap-2 mb-4">
                            ...
                            <p className="text-lg leading-none text-muted-foreground">{qualification}</p>
